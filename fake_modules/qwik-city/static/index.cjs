...
function getEntryModule() {
  ...
  console.trace("entryModule", entryModule);
  if (isCjs()) {
...
function isNode() {
  ...
  return (
    ...
    !!((_a = process.versions) == null ? void 0 : _a.node)
  );
}
function isCjs() {
  const req = "require";
  console.log("isNode()", isNode());
  console.log(" typeof globalThis[req]", typeof globalThis[req]);
