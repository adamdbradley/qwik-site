...
function cloudflarePagesAdaptor(opts = {}) {
  ...
  return viteAdaptor({
    ...
    async generate({ clientOutDir, basePathname }) {
      const routesJsonPath = join4(clientOutDir, "_routes.json");
      const hasRoutesJson = fs4.existsSync(routesJsonPath);
      if (!hasRoutesJson && opts.functionRoutes !== false) {
        ...
        await fs4.promises.writeFile(routesJsonPath, JSON.stringify(routesJson, void 0, 2));
      }
    }
  });
}
