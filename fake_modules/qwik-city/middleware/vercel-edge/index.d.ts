 ...
 * @alpha
 */
export declare function createQwikCity(opts: QwikCityVercelEdgeOptions): ({ request, env }: EventPluginContext) => Promise<Response>;
 ...
 * @alpha
 */
export declare type RequestHandlerVercelEdge<T = unknown> = RequestHandler_2<T, {
